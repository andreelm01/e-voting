    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
          ...
          @endif
          <h5 class="m-0 mt-3 font-weight-bold text-primary" align="center"><b>E-Voting</b></h5>
        </div>

        <!-- Login Form -->
        <form action="{{url('/user-login-check')}}" method="POST">
          @csrf
          <input type="text" id="login" class="fadeIn second @error('username') is-invalid @enderror" name="username" placeholder="username" required="">
